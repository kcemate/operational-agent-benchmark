...
# P01 data-rollup needs 3 reads + 1 write + 1 final (5 controller turns).
# Budget one spare turn so a competent multi-turn loop can complete.
MAX_BROKER_STEPS_PER_PROBE = 6
MAX_API_CALLS_PER_PHYSICAL_ATTEMPT = 6
MIN_API_CALLS_PER_READY_PHYSICAL_PROBE = 2
FIRST_ATTEMPT_API_CALL_CEILING_PER_ROUTE = 12
MAX_INFRASTRUCTURE_RETRIES_PER_PROBE = 1
MAX_PHYSICAL_ATTEMPTS_PER_ROUTE = 4
ABSOLUTE_API_CALL_CEILING_PER_ROUTE = 24
